...
* A [vs-mlrt RIFE ONNX model](https://github.com/AmusementClub/vs-mlrt/releases) (`rife v1` interface), or a Practical-RIFE checkpoint converted with [rife2onnx](Tools/rife2onnx).
